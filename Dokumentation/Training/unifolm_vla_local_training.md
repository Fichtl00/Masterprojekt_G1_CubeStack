...
- **Closed-Loop:** siehe [`groot_vs_unifolm_vla_vergleich.md`](groot_vs_unifolm_vla_vergleich.md) für die Architektur (HTTP-Server + Isaac-Lab-Bridge) und [`cube_stack_eval_env.md`](../Simulation/cube_stack_eval_env.md) für die Eval-Umgebung.
