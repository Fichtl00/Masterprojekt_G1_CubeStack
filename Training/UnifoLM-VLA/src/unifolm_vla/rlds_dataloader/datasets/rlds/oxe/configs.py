...
class StateEncoding(IntEnum):
    ...
    JOINT_G1_DEX3 = 7       # 2 x [Arm Joint Angles (7) + Dex3 Hand Joint Angles (7)] -- no waist
    # fmt: on
...
OXE_DATASET_CONFIGS = {
    ...
    # === g1_dex3_blockstacking Fine-Tuning Dataset (from unitreerobotics/G1_Dex3_BlockStacking_Dataset) ===
    # Joint-space (no EE-pose conversion): 28-dim state/action = 14 arm joints + 14 Dex3 hand joints, no waist.
    # Only 3 of the source dataset's 4 cameras are used (cam_right_high dropped), matching Unitree's own
    # G1 pretraining setup (primary + left_wrist + right_wrist, no "secondary" head camera).
